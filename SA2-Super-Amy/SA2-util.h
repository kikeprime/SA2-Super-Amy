...
VoidFunc(sub_720698, 0x720698);
FunctionPointer(void, sub_420510, (int a2, float a3, float a4, int argC), 0x420510);
//FunctionPointer(void, sub_7802B0, (float a1, float a2, float a3, float a4), 0x7802B0);
UsercallFuncVoid(sub_7802B0, (float a1, float a2, float a3, float a4), (a1, a2, a3, a4), 0x7802B0, rEAX, stack4, stack4, stack4);
...
//DataPointer(ModelFuncPtr, sub_71F040, 0x71F040);
FunctionPointer(void, DrawObjWithCallBack, (NJS_OBJECT* obj), 0x42E730);
FunctionPointer(void, sub_71FBE0, (NJS_OBJECT* mdl), 0x71FBE0); // Metal Sonic Callback
FunctionPointer(void, sub_71F040, (NJS_OBJECT* mdl), 0x71F040); // Amy Rose Callback
